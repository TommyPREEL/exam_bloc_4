...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $updateQuery = "UPDATE livres SET titre = '$title', auteur = '$author', description = '$description', date_publication = '$date_publication', isbn = '$isbn', photo_url = '$coverUrl' WHERE id = $book_id";
